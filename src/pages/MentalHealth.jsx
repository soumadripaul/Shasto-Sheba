...
const MentalHealth = () => {
  ...
  const moods = [
    { emoji: '😊', label: 'ভালো', value: 'good', color: '#4ade80' },
    { emoji: '😐', label: 'মোটামুটি', value: 'okay', color: '#fbbf24' },
    { emoji: '😞', label: 'খারাপ', value: 'bad', color: '#f87171' }
  ];
    ...
    <div className="mental-health-container">
      <div className="mental-health-content">
        ...
        <p className="page-subtitle">
          আপনার মানসিক অবস্থা জানান। এটি সম্পূর্ণ গোপনীয় এবং শুধুমাত্র আপনার ফোনে সংরক্ষিত থাকবে।
        </p>
        ...
        <div className="privacy-notice">
          ...
          <p>আপনার সকল তথ্য শুধুমাত্র আপনার ফোনে সংরক্ষিত। কোনো সার্ভারে পাঠানো হয় না।</p>
        </div>
      </div>
    </div>
  );
